...
#SBATCH --partition=himem                        # Set which partition to use
#SBATCH --mail-user=joe.wilde@bioss.ac.uk
#SBATCH --mail-type=END,FAIL

# Print job details
echo "Running R script: code/PA sites/1_no_manage/As_sites/6_run simulation.R"
