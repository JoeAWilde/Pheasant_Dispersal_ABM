...
for(ss in c("A", "B", "D")){
  ...
  ggsave(p1, filename = paste0("outputs/script_9/APHA data/site ", ss, "/distance_counts_rp.png"), units = "px", height = 4320, width = 7980)
  ...
  p2 <- ggplot(data = final_df) +
    ...
    facet_wrap(vars(month))
  p2
  ggsave(p2, filename = paste0("outputs/script_9/APHA data/site ", ss, "/distance_prop_rp.png"), units = "px", height = 4320, width = 7980)
}